    ...
    return (
      ...
      >
        <div className="magic-wand bounce-xy" onClick={(e) => switchTheme()}>
          <button className="fab fa-nintendo-switch fa-lg" href="#" />
          <div className="magic-text">Zmień tło</div>
        </div>
        <style jsx="true">
          {`
            .menu__item:hover {
        ...
        <div className="menu">
          <div style={{animation: 'bounce-xy 3s infinite'}}
          ...
          <div
            style={{animation: 'bounce-xy 2s infinite'}}
